...
* RTOS none
* Concurrency Embassy executor
* HAL esp hal for ESP32 S3
* USB embassy usb
* BLE NimBLE via esp ble if available in no std, else feature gated for later
* Storage NVS and flash partitions
* Serialization minicbor or postcard for on device messages
