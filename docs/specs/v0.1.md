...
* Boot animations, visual presets, and other cosmetic transitions (former §9 content)
* Contextual hint bars and screen overlays for help prompts
* Animation speed toggles and per-action delay customization
* Macro language implementation described in §11
* Tag-based search, fuzzy matching, and advanced filtering (§12)
